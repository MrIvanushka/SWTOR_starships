...
#ifndef SWTOR_PLAYERMOVEMENTCONTROLLER_H
#define SWTOR_PLAYERMOVEMENTCONTROLLER_H
...
public:
    PlayerMovementController(GameObject* object) : Component(object)
    {
...
#endif //SWTOR_PLAYERMOVEMENTCONTROLLER_H
